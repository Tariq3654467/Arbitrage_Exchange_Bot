...
interface ExchangePairData {
  pair: string;
  count: number;
  avg_profit: number;
}

interface ExchangePairChartProps {
  data: ExchangePairData[];
  title: string;
}

const COLORS = ['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899'];

export default function ExchangePairChart({ data, title }: ExchangePairChartProps) {
